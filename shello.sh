...
CNC='\033[1;38;5;051m'
function banner(){
echo -e ${RED}"_________________________________________________________________________________________"
echo -e ${PINK}"                                        SHELLO                                          " 
echo -e ${CNC}"              Generate shellos faster than light ~ Yuma-Tsushima07                       " 
echo -e ${BLUE}"                               Coded By: @Yuma-Tsushima07                               "
echo -e ${RED}"_________________________________________________________________________________________"
...
echo -e ${YELLOW}"\n[*] Choose Type Of Reverse Shell \n"
		...
		echo -e "${NC}[${CG}"6"${NC}]${CNC} Ncat.exe -e Shell "
                echo -e "${NC}[${CG}"7"${NC}]${CNC} More Windows Shells "
